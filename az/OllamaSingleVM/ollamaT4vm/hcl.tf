terraform {
  ...
  backend "azurerm" {
    ...
    key                  = "ollama-t4-vm.terraform.tfstate"
  }
}
...
variable "prefix"            { default = "ollama-low" }
variable "location"          { default = "westus" } # change to your region
variable "zone"              { default = "1" }
variable "vm_size"           { default = "Standard_NC4as_T4_v3" } # T4 GPU
