terraform {
  ...
  backend "azurerm" {
    ...
    key                  = "ollama-a100-vm.terraform.tfstate"
  }
}
...
variable "prefix"            { default = "ollama-a100" }
variable "location"          { default = "eastus" } # A100 availability
variable "zone"              { default = "1" }
variable "vm_size"           { default = "Standard_ND96asr_v4" } # A100 GPU
...
variable "model_disk_size_gb"{ default = 1024 } # Larger for A100 workloads
